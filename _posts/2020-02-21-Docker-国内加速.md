...
docker-machine create --engine-registry-mirror=https://zj70ve2y.mirror.aliyuncs.com -d virtualbox default
...
https://zj70ve2y.mirror.aliyuncs.com加到"registry-mirrors"的数组里，点击 Apply & Restart按钮，等待Docker重启并应用配置的镜像加速器。
```
...
docker-machine create --engine-registry-mirror=https://zj70ve2y.mirror.aliyuncs.com -d hyperv default
